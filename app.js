...
nav.innerHTML='<a class="a" href="#">Helo<em>Basket</em></a>'
...
rightContainerTopic.innerHTML='<h1 class="topic1">Basket</h1> '
...
function mainProjectLoadingItems(){
  ...
  if (selectedListId ==null){
    listDisplayContainer.style.display='none'
      ...
      listTitleElement.innerHTML = 'Groceries Of <em>'+selectedList.project_name+'</em>'
